...
--- Sprawdzam ile mamy inikalne dzienne ceny wypozyczen filmow  --- 
...
AS
	SELECT  film_id
,			rental_rate
, 			count(film_id)	ilosc_wypozyczen
...
SELECT  rental_rate
,		sum (ilosc_wypozyczen) wypozyczenia
...
--SPOSTRZE¯ENIA: Lekko ujemna (-0.05 ) korelacja, œwiadcz¹ca o niejakim braku zale¿noœci pomiêdzy cen¹ za wypo¿yczenie filmu,
--a iloœci¹ jego wypo¿yczeñ. 
